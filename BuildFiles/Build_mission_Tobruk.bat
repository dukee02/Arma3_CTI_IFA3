...
copy "%gitpath%\IFA3-BECTI.mapname\RSC\Parameters_d.hpp" "%buildpath%\%missionfloder%\RSC\Parameters.hpp"
...
copy "%gitpath%\IFA3-BECTI.mapname\mission_%Map_name%.sqm" "%buildpath%\%missionfloder%\mission.sqm"
