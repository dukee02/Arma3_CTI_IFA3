...
set mapname="Normandy"
set missionfloder="VIO-BECTI-SPE_IFA3.SPE_%mapname%"
...
copy "%gitpath%\IFA3-BECTI.mapname\RSC\Parameters_SPE.hpp" "%buildpath%\%missionfloder%\RSC\Parameters.hpp"
...
copy "%gitpath%\IFA3-BECTI.mapname\mission_SPE_%mapname%.sqm" "%buildpath%\%missionfloder%\mission.sqm"
