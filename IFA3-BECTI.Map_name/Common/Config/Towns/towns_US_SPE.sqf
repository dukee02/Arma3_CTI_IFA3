...
if(CTI_ECONOMY_LEVEL_WHEELED >= _level) then {
	WHEELED_LIGHT = [[format["%1SPE_US_G503_MB_M1919", _sid],1]];
	WHEELED_HEAVY = [[format["%1SPE_US_G503_MB_M2", _sid],1]];
};

_matrix_cnt = [_matrix_cnt, _matrix_full, _matrix_nation] call CTI_CO_FNC_CheckCountUp;
if(_matrix_cnt >= 0) then {_level = _matrix_cnt; _matrix_cnt = _matrix_cnt + 1;};
if(CTI_ECONOMY_LEVEL_WHEELED >= _level) then {
	WHEELED_LIGHT pushBack [format["%1SPE_US_G503_MB_M2", _sid],1];
	WHEELED_LIGHT pushBack [format["%1SPE_US_G503_MB_M1919_Armoured", _sid],1];
	WHEELED_LIGHT pushBack [format["%1SPE_US_G503_MB_M2_Armoured", _sid],1];
...
if(_matrix_cnt >= 0) then {_level = _matrix_cnt; _matrix_cnt = _matrix_cnt + 1;};
if(CTI_ECONOMY_LEVEL_WHEELED >= _level) then {
	WHEELED_HEAVY pushBack [format["%1SPE_M20_AUC", _sid],1];
};

_matrix_cnt = [_matrix_cnt, _matrix_full, _matrix_nation] call CTI_CO_FNC_CheckCountUp;
if(_matrix_cnt >= 0) then {_level = _matrix_cnt; _matrix_cnt = _matrix_cnt + 1;};
if(CTI_ECONOMY_LEVEL_WHEELED >= _level) then {
	WHEELED_HEAVY pushBack [format["%1SPE_M8_LAC_ringMount", _sid],1];
	WHEELED_HEAVY pushBack [format["%1SPE_M8_LAC", _sid],1];
};
...
if(CTI_ECONOMY_LEVEL_TRACKED >= _level) then {
	...
	TRACKED_HEAVY pushBack [format["%1SPE_M4A0_composite", _sid],1];
};
...
if(CTI_ECONOMY_LEVEL_TRACKED >= _level) then {
	...
	TRACKED_MEDIUM pushBack [format["%1SPE_M4A0_composite", _sid],1];
	TRACKED_HEAVY = [[format["%1SPE_M4A1_75", _sid],1]];
	TRACKED_HEAVY pushBack [format["%1SPE_M4A1_75_erla", _sid],1];
};
...
if(CTI_ECONOMY_LEVEL_TRACKED >= _level) then {
	...
	TRACKED_MEDIUM pushBack [format["%1SPE_M4A1_75_erla", _sid],1];
	TRACKED_HEAVY = [[format["%1SPE_M4A1_T34_Calliope_Direct", _sid],1]];
	TRACKED_HEAVY pushBack [format["%1SPE_M4A0_105", _sid],1];
};
...
if(CTI_ECONOMY_LEVEL_TRACKED >= _level) then {
	...
	TRACKED_MEDIUM pushBack [format["%1SPE_M4A1_T34_Calliope_Direct", _sid],1];
	TRACKED_MEDIUM pushBack [format["%1SPE_M4A0_105", _sid],1];
	TRACKED_HEAVY = [[format["%1SPE_M4A1_76", _sid],1]];
};

_matrix_cnt = [_matrix_cnt+ 1, _matrix_full, _matrix_nation] call CTI_CO_FNC_CheckCountUp;
if(_matrix_cnt >= 0) then {_level = _matrix_cnt; _matrix_cnt = _matrix_cnt + 1;};
if(CTI_ECONOMY_LEVEL_TRACKED >= _level) then {
	TRACKED_MEDIUM pushBack [format["%1SPE_M4A1_76", _sid],1];
	TRACKED_HEAVY = [[format["%1SPE_M4A3_75", _sid],1]];
	TRACKED_HEAVY pushBack [format["%1SPE_M4A3_105", _sid],1];
	TRACKED_HEAVY pushBack [format["%1SPE_M4A3_76", _sid],1];
	TRACKED_HEAVY pushBack [format["%1SPE_M4A3_T34_Calliope_Direct", _sid],1];
};
